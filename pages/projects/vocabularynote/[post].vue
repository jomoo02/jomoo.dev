  ...
  <div class="relative grid grid-cols-10 gap-6 md:gap-8">
    ...
    <div class="min-w-full col-span-10 md:col-span-8 pb-8">
      ...
      <div
        ...
        :class="pageNumber < vocabularynotePosts.length - 1 ? 'justify-between' : 'justify-end'"
      >
        <div v-if="pageNumber < vocabularynotePosts.length - 1" class="md:w-1/3">
          <PostMoveCard
            :post-direction="BEFORE"
            :page-number="pageNumber + 1"
            data-kind="vocabularynote"
          />
        </div>
...
const pageNumber = vocabularynotePosts.findIndex(({ title }) => post.title === title);
</script>
