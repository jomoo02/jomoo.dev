<template>
    <div class="relative grid grid-cols-10 gap-6 md:gap-8">
        ...
        <div class="col-span-10 md:col-span-8">
            <div v-for="wootecos in postStore.wootecoPosts" :key="wootecos">
                <div>
                    <ContentCard :page-link="wootecos._path" :description="wootecos.description" :title="wootecos.title" :date="wootecos.date" ></ContentCard>
                </div>
            </div>
        </div>
    </div>
...
useHead({
    title: '우아한테크코스',
    meta:[
        { name: 'description', content: '우아한테크코스'}
    ],
})
</script>